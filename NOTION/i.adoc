...
If less administration is preferred then opt for a file sharing service like the defunct Firefox Send. The links to files can expire and password protected. Since the files are stored on the server you still need skilled staff to maintain and monitor this service.
